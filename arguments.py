...
def parse_game_args():
    ...
    paa('--scenario_dir',       default='scenarios/',           help='location of game scenarios',  type=str)    
    ...
    paa('--num_mazes_test',     default=1,                      help='the number of testing mazes, only valid for multimaze',type=int)
    ...
    paa('--conv_filters',       default=32,     help='Number of convolutional filters' , type=int)   
    ...
    paa('--recurrent_policy',   default=False,  help='use a gru recurrent policy', action='store_true')    
    ...
    paa('--log_interval',   default=10,                     help='How often to log', type=int)
